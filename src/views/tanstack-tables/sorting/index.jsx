...
const TableWithSorting = () => {
  ...
  return <div className="content-wrapper">
      <PageBreadcrumb title={'TanStack Table with Sorting'} subTitle1={'Data Visualization'} subTitle2={'Tanstack Table'} subText={'Loading the table with minimal settings & static data.'} />
