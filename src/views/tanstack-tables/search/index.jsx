...
const TableWithSearch = () => {
  ...
  return <div className="content-wrapper">
      <PageBreadcrumb title={'TanStack Table with Search'} subTitle1={'Data Visualization'} subTitle2={'Tanstack Table'} subText={'Loading the table with minimal settings & static data.'} />
