...
const SmartAdminIcons = () => {
  ...
  const [iconSet, setIconSet] = useState('smart-admin');
  ...
  return <div className="content-wrapper">
      <PageBreadcrumb title={'SmartAdmin Icons'} subTitle1={'Design'} subTitle2={'Iconography'} subText={'An extreamly lightweight icon set, to meet your basic needs.'} />
