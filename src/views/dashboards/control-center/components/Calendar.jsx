...
const Calendar = () => {
  ...
  return <div id="panel-3" className="panel panel-icon">
      <div className="panel-container">
        <div className="panel-content">
          <FullCalendar initialView="dayGridMonth" plugins={[dayGridPlugin, timeGridPlugin, listPlugin]} bootstrapFontAwesome={false} handleWindowResize={true} themeSystem={'bootstrap'} headerToolbar={{
          ...
          day: 'Day',
          list: 'List'
        }} dayMaxEvents={2} height={760} events={eventData} />
        </div>
      </div>
    </div>;
};
