...
export const developmentPhasesChartOptions = () => ({
  chart: {
    height: 600,
  ...
  tooltip: {
    custom: function (opts) {
      ...
      return '<div class="arrow_box p-2">' + '<div class="fw-bold mb-1">' + data.team + '</div>' + '<div>' + data.activity + '</div>' + '<div><small class="text-danger">Phase: ' + data.phase + '</small></div>' + '<div class="mt-2"><small>Start: ' + from + '</small></div>' + '<div><small>End: ' + to + '</small></div>' + '<div><small>Duration: <span class="fw-bold">' + duration + ' days</span></small></div>' + assignedMembersHtml + '</div>';
    }
  },
  legend: {
    show: false
...
export const projectProgressChartOptions = () => ({
  series: [{
  ...
  fill: {
    ...
    gradient: {
      ...
      type: 'vertical',
      shadeIntensity: 0.5,
      gradientToColors: [getColor('success', 400)],
      // End color (top)
      opacityFrom: 0.8,
      // Higher opacity at bottom
      opacityTo: 0.2,
      // Lower opacity at top
      stops: [0, 90, 100],
      colorStops: [{
        offset: 0,
...
export const teamPerformanceChartOptions = () => ({
  series: [{
...
export const weeklyActivityChartOptions = () => ({
  ...
  colors: [getColor('success', 400), getColor('primary', 400) // New
  ],
  plotOptions: {
    bar: {
      horizontal: false,
...
export const teamWorkloadChartOptions = () => ({
  chart: {
    height: 370,
    type: 'heatmap',
    toolbar: {
...
export const projectTimelineChartOptions = () => ({
  chart: {
    height: 370,
    type: 'rangeBar',
    fontFamily: 'inherit',
  ...
  tooltip: {
    custom: function (opts) {
      ...
      return '<div class="arrow_box p-2">' + '<div class="font-weight-bold mb-1">' + seriesName + ': ' + taskName + '</div>' + '<div>Start: ' + from + '</div>' + '<div>End: ' + to + '</div>' + '<div>Duration: ' + duration + ' days</div>' + '</div>';
    }
  },
  legend: {
    position: 'top',
