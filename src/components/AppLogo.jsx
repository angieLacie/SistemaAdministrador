...
const AppLogo = () => {
  return <Link to="/dashboards/control-center" className="app-logo flex-shrink-0" data-prefix="v5.2.0" data-action="playsound" data-soundpath="media/sound/" data-soundfile="sawhisp.mp3">
